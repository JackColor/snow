...
from snow.forms.basefrom import BoostrapForm
...
class PermissionFrom(BoostrapForm):
    class Meta:
        model = Permission
        exclude = ["pid"]


class LastPermissionFrom(BoostrapForm):
    class Meta:
        model = Permission
        fields = ["title", "allow_url", "url_name"]
